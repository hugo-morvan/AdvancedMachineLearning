...
GPfitfraud <- gausspr(fraud ~  varWave + skewWave , data=data[SelectTraining,])
...
points(data[data[,5]==0,1],data[data[,5]=='0',2],col=alpha("red",0.4), pch=20) # Not fraud
points(data[data[,5]==1,1],data[data[,5]=='1',2],col=alpha("blue",0.4), pch=20) #Fraud
...
cm = confusionMatrix(predsTest, data[test_idx,5])
print(cm$overall[1])
print(cm$table)
```
